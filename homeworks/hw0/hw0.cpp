...
public:
	...
	// https://github.com/SaschaWillems/Vulkan/commit/d0211d1f1443da42171fa4ccb36eb9ee01a6cc50
	...
	void preparePipelines()
	{
		...
		shaderStages[0].module = loadSPIRVShader("shaders/glsl/hw0/homework0.vert.spv");
		...
		// Load binary SPIR-V shader
		shaderStages[1].module = loadSPIRVShader("shaders/glsl/hw0/homework0.frag.spv");
		// Main entry point for the shader
